...
try {
    Write-OpenJocHeader 'OpenJOC LAV Installer 0.18.0'
    ...
    if (-not $preflight.Success) {
        ...
        exit (Complete-OpenJocSession $session 20 'INSTALLATION FAILED' 'The extracted package is incomplete or unsupported.' 'Check package files' 'Extract a fresh copy of the complete v0.18.0 ZIP, then run install.bat again.' $preflight.Detail)
    }
