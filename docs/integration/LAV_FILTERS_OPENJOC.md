...
and virtual-layout settings. Built-in SADIE II / KU100 with **7.1.4 (Default)**
is the default; the selector also exposes SADIE II / KEMAR and **Custom SOFA**
as an explicit validated local-file choice; and
