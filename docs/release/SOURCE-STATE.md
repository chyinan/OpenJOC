...
# OpenJOC LAV 0.17.0 source state

- OpenJOC revision: exact remediation branch HEAD is recorded in `REPRODUCIBILITY-MANIFEST.txt`
- LAV downstream release revision: `147c24fe1489ded5473c2a09987430ca1070a412`
...
The source candidate includes all 14 modified upstream LAV files and all new
...
`147c24fe1489ded5473c2a09987430ca1070a412`, and upstream base
