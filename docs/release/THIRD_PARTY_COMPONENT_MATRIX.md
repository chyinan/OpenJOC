...
|---|---|---|---|---|---|
| LAV Audio Decoder + OpenJOC glue | LAV 0.83 / `fefb698...` + recorded downstream changes | `LAVAudio.ax` | Full snapshot, patch, new files | Effective GPL-3.0-only combined work | COMPLETE |
