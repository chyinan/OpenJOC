...
|---|---|---|---|---|---|
| LAV Audio Decoder + OpenJOC glue | downstream `724741d...` on LAV 0.83 / upstream base `fefb698...` + recorded changes | `LAVAudio.ax` | Full snapshot, patch, new files | Effective GPL-3.0-only combined work | COMPLETE |
