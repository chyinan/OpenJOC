...
| What does the current development line support? | [CAPABILITIES.md](CAPABILITIES.md) |
...
| How did the evidence boundary evolve? | [research/README.md](research/README.md) |
...
Current snapshot documents own current truth. The research directory preserves
historical evidence and negative results and is not a competing status source.
