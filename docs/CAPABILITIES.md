# OpenJOC 0.7.0 capabilities

This is the canonical current capability status for the OpenJOC 0.7.0
...
| Integration | Versioned C ABI 1.1 | `ADMITTED_WITH_SCOPE` | Public `openjoc.h`, opaque handles, numeric statuses, `struct_size` fallback, C11/C++ compilation, instance-owned errors, and panic containment | Experimental ABI; compatibility may evolve during OpenJOC 0.x; player/framework adapters are not shipped |
