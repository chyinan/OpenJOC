...
| Rendering | Explicit-scene 3D speaker topology and VBAP triplet renderer | `ADMITTED_WITH_SCOPE` | `openjoc-render` checked 3×3 public-math oracle, tetrahedron/octahedron/partial/ambiguity and partition tests | Caller supplies speaker order and triplets explicitly; no automatic triangulation, Delaunay/hull inference, LFE, trajectories, JOC bridge, or authored-object identity |
