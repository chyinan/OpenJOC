# OpenJOC 0.4.0 capabilities

This is the canonical current capability status for the OpenJOC 0.4.0
...
| Release | OpenJOC 0.4.0 Apple-Silicon release asset | `ADMITTED_WITH_SCOPE` | Local source/release build, bundle verification, and CLI smoke checks on Apple-silicon macOS | The published asset is ad-hoc signed and not notarized; Windows/Linux evidence remains historical 0.2.0 scope |
