...
pub use speaker_layouts::{
    ...
    SPEAKER_LAYOUT_PRESET_NAMES, SpeakerChannelMaskError, SpeakerLayoutPreset,
    SpeakerLayoutPresetError, speaker_channel_mask_for_labels, speaker_layout_5_1_4,
    speaker_layout_7_1_2, speaker_layout_preset,
};
