...
workspace_fmt = PASS: `cargo fmt --all -- --check`
workspace_check = PASS: `cargo check --workspace`
workspace_clippy = PASS: `cargo clippy --workspace --all-targets --all-features`
workspace_tests = PASS: `cargo test --workspace`
