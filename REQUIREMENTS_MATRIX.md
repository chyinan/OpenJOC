...
| TS 103 420 5.2.1.2, 5.6.1 | Position, size, priority, gain, lock, zones | `openjoc-oamd` | boundary/exhaustive tables, finite/infinite outside-room projection, invalid centre-ray/factor, and integrated object-update tests pass | implemented |
