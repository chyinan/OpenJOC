...
| TS 103 420 6.4 | JOC input/output/control boundary | `openjoc-joc`, `openjoc-scene` | stateful QMF-to-object-PCM frame test passes; public PCM `JocFrameInput` remains | implemented |
