...
| TS 103 420 8.1, E.3 | Required E-AC-3 downmix and substream behavior | `openjoc-eac3`, `openjoc-cli` | indexed I0/optional D0 PCM assembly, normative replacement/supplement mapping, exact access-unit rate/sample alignment, and `--internal-base` ObjectScene path; legal real-vector proof remains | implemented |
