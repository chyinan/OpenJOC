...
| TS 102 366 Annex E.1.2 | E-AC-3 syncframe syntax, size and timing | `openjoc-eac3` | bounded acquisition header, conditional BSI/addbsi extraction, option-4 mixdata bound, complete `audfrm` state and exact first-`audblk` offset pass; `audblk`, exponent, bit-allocation, and mantissa traversal remain | implemented |
