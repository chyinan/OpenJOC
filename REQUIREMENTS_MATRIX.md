...
| TS 102 366 6.2, E.2.4.3 | Fixed-point decoder bit allocation | `openjoc-eac3` | exhaustive exponent-to-PSD, Tables 6.6-6.13 parameter/band mappings, and all conventional/AHT pointer entries pass; PSD integration onward remains planned pending resolution of the damaged page-58 `logadd` glyph | implemented |
