...
| TS 103 420 6.4 | JOC input/output/control boundary | `openjoc-joc`, `openjoc-scene` | stateful QMF input/output frame test passes; public `JocFrameInput` remains | implemented |
