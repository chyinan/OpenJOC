...
| TS 103 420 5.6.2 | Metadata timing and ramp semantics | `openjoc-oamd` | four updates, offset arithmetic, fixed/indexed ramp forms pass; frame-offset state remains | implemented |
