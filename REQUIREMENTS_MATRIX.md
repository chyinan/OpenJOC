...
| TS 102 366 6.2 | Fixed-point decoder bit allocation | `openjoc-eac3` | exhaustive exponent-to-PSD mapping passes; PSD integration onward remains planned pending resolution of the damaged page-58 `logadd` glyph | implemented |
