...
| TS 102 366 6.2, E.2.4.3 | Fixed-point decoder bit allocation | `openjoc-eac3` | exhaustive exponent-to-PSD, Table 6.14 log-addition/integration, Tables 6.6-6.13 parameter/band mappings, and all conventional/AHT pointer entries pass; excitation/masking/mantissa traversal remains planned | implemented |
