...
| TS 102 366 6.2 | Fixed-point decoder bit allocation | `openjoc-eac3` | exhaustive exponent-to-PSD, Tables 6.6-6.13 parameter/band mappings, and all 64 Table 6.16 pointers pass; PSD integration onward remains planned pending resolution of the damaged page-58 `logadd` glyph | implemented |
