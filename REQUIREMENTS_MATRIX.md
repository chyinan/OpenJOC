...
| TS 102 366 6.2 | Fixed-point decoder bit allocation | `openjoc-eac3` | exhaustive exponent-to-PSD, Tables 6.6-6.11 parameter mappings, and Tables 6.12-6.13 band/bin mappings pass; PSD integration onward remains planned pending resolution of the damaged page-58 `logadd` glyph | implemented |
