...
def package_sdk(args: argparse.Namespace) -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="openjoc-sdk-") as temporary:
        ...
        write_build_info(stage, "sdk", platform, {"c_abi": "1.6-experimental", "runtime_model": "consumer links the packaged C ABI library", "runtime_dependency_closure": runtime_closure})
